...
class MultiVELlavaMetaModel:
    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        multiple_vision_towers = model_args.multiple_vision_towers
        ...
        if self.get_multiple_vision_towers() is None:
            ...
            if fsdp is not None and len(fsdp) > 0:
                multiple_vision_towers = self.multiple_vision_towers[0]
            else:
                multiple_vision_towers = self.multiple_vision_towers
            for vt in multiple_vision_towers:
                vt.load_model()

...
def load_multi_ve_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    ...
    if load_8bit:
        ...
        kwargs['torch_dtype'] = torch.float16 ###### FIXME: 
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            # FIXME: This branch is not modified for MultiVELlava
    ...
    if 'llava' in model_name.lower():
        ...
        multiple_image_processors = list()
        
        for idx in range(len(multiple_vision_towers)):    
